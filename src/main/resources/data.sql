...
---Items ----
INSERT INTO "PUBLIC"."items" ("id","price","type","name","bill_id")VALUES(1,20,'GROCERY','meet',1);
INSERT INTO "PUBLIC"."items" ("id","price","type","name","bill_id")VALUES(2,10,'GROCERY','bean',1);
INSERT INTO "PUBLIC"."items" ("id","price","type","name","bill_id")VALUES(3,30,'GROCERY','Tomato',1);
INSERT INTO "PUBLIC"."items" ("id","price","type","name","bill_id")VALUES(4,15.5,'PERSONAL_HYGIENE','Deodorant',1);
INSERT INTO "PUBLIC"."items" ("id","price","type","name","bill_id")VALUES(5,30,'PERSONAL_HYGIENE','Shampoo',1);
INSERT INTO "PUBLIC"."items" ("id","price","type","name","bill_id")VALUES(6,60,'PERSONAL_HYGIENE','Kleenex',1);