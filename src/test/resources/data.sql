...
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(21,20,'GROCERY','meet',3,'mee23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(22,10,'GROCERY','bean',3,'bea33');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(23,30,'GROCERY','Tomato',3,'tom23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(24,15.5,'PERSONAL_HYGIENE','Deodorant',3,'Deo23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(25,30,'PERSONAL_HYGIENE','Shampoo',3,'sha23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(26,60,'PERSONAL_HYGIENE','Kleenex',3,'kle23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(29,60,'PERSONAL_HYGIENE','Kleenex',3,'kle23');
...
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(31,20,'GROCERY','meet',4,'mee23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(32,10,'GROCERY','bean',4,'bea33');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(33,30,'GROCERY','Tomato',4,'tom23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(34,15.5,'PERSONAL_HYGIENE','Deodorant',4,'Deo23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(35,30,'PERSONAL_HYGIENE','Shampoo',4,'sha23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(36,60,'PERSONAL_HYGIENE','Kleenex',4,'kle23');
INSERT INTO "PUBLIC"."item" ("id","price","type","name","bill_id","code")VALUES(39,60,'PERSONAL_HYGIENE','Kleenex',4,'kle23');
